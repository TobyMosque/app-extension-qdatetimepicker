      ...
      <div class="col col-4 q-pa-md">
        <q-card>
          ...
          <q-card-section>
            ...
            <q-datetime-picker class="q-mb-md" standout label="Standout DateTime Picker" :date="true" :time="true" color="positive" v-model="datetime" :format24h="false"></q-datetime-picker>
          </q-card-section>
        </q-card>
      </div>
    </div>
