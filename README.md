...
| date-options | Function or Array | Optionally configure what date is the user allowed to set |
| time-options | Function or Array | Optionally configure what time is the user allowed to set |
